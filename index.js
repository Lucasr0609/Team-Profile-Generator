...
const pathOutput = path.join(DIR_OUTPUT, "team.html");
const teamGenerate = require("./src/template.js")
...
function runApp () {
  ...
  function createTeam () {
    inquirer.prompt([{
      type: "list",
      message: "Type of employee would you like to add to your team?",
...
function htmlBuilder () {
    ...
    fs.writeFileSync(pathOutput, teamGenerate(teamArray), "UTF-8")
